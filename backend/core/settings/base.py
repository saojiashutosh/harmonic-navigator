...
# Concert Mode integrations. Both are optional — discovery needs a Ticketmaster
# key; setlist weighting needs a setlist.fm key. Missing keys degrade
# gracefully (see concerts/services.py) rather than crashing.
